...
try:
    ...
    cur.execute('CREATE TABLE IF NOT EXISTS tOrders(Name_of_customer, id_car, cargo, end_datetime, FOREIGN KEY(Name_of_customer) REFERENCES tUsers(Name), FOREIGN KEY(id_car) REFERENCES tCars(id))')
